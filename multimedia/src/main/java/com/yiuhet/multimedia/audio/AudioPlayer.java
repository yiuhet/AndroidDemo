...
public class AudioPlayer {
    ...
    private static final int DEFAULT_SAMPLE_RATE = 44100;//采样率 44.1kHz
    private static final int DEFAULT_CHANNEL_CONFIG = AudioFormat.CHANNEL_IN_STEREO;//通道数 双通道
    private static final int DEFAULT_AUDIO_FORMAT = AudioFormat.ENCODING_PCM_16BIT;//数据位宽 16bit
